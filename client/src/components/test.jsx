                ...
                {cartItems.length > 0 && (
                  <>
                    ...
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 text-gray-800 font-light mb-6">
                      <div className="w-full p-3 border-b border-gray-200">
                        ...
                        {selectedPaymentMethod === 'PayPal' && (
                          <div id="paypalForm">
                            <p>Vous serez redirigé vers PayPal pour terminer votre achat.</p>
                            <button
                              onClick={handlePayWithPayPal}
                              className="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold mt-4"
                            >
                    ...
                    <div>
                      ...
                      >
                        {selectedPaymentMethod === 'Visa' ? 'Payer avec Visa' : 'Payer avec PayPal'}
                      </button>
